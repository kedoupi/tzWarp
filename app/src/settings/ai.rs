...
impl DefaultSessionMode {
    ...
    pub fn display_name(&self) -> &'static str {
        match self {
            ...
            DefaultSessionMode::CloudAgent => "云端智能体",
            DefaultSessionMode::TabConfig => "标签配置",
    ...
    pub fn default_session_mode(&self, app: &AppContext) -> DefaultSessionMode {
        ...
        match mode {
            ...
            DefaultSessionMode::Agent | DefaultSessionMode::CloudAgent => {
                ...
                } else if cfg!(feature = "team_relay") && mode == DefaultSessionMode::CloudAgent {
                    // tzWarp 没有 Warp 云端 Agent，旧设置回落到本地智能体。
