...
const COMMAND_WAITING_FOR_USER_MESSAGE: &str = "可以运行这条命令并读取输出吗？";
const MCP_TOOL_WAITING_FOR_USER_MESSAGE: &str = "可以调用这个 MCP 工具吗？";
const MONITORING_COMMAND_MESSAGE: &str = "智能体正在监视命令…";
const AGENT_NEEDS_INPUT_MESSAGE: &str = "智能体需要你的输入才能继续";
const USER_TOOK_CONTROL_COMMAND_MESSAGE: &str = "当前由你控制。";
const USER_STOPPED_CLI_SUBAGENT_COMMAND_MESSAGE: &str = "智能体已暂停，当前由你控制。";
const AGENT_REQUESTED_USER_TAKE_CONTROL_COMMAND_MESSAGE: &str = "当前由你控制";
