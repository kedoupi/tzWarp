...
const ENABLE_NLD_TOOLTIP: &str = "开启终端命令自动识别";
const DISABLE_NLD_TOOLTIP: &str = "关闭终端命令自动识别";

const FAST_FORWARD_ON_TOOLTIP: &str = "关闭自动批准智能体操作";
const FAST_FORWARD_OFF_TOOLTIP: &str = "自动批准此任务的全部智能体操作";
