...
impl AppearanceSettingsPageView {
    ...
    fn build_page(ctx: &mut ViewContext<Self>) -> PageType<Self> {
        ...
        if !tools_panel_widgets.is_empty() {
            categories.push(Category::new("工具面板", tools_panel_widgets));
        }
    ...
    fn workspace_decoration_visibility_dropdown_item_label(
        ...
        match value {
            ...
            WorkspaceDecorationVisibility::HideFullscreen => "全屏时隐藏标签栏（窗口化时显示）",
    ...
    fn render(
        ...
        Flex::column()
            ...
            .with_child(
                appearance
                    .ui_builder()
                    .span("系统切换浅色/深色时自动同步主题。".to_string())
                    .with_style(
...
impl SettingsWidget for CustomAppIconWidget {
    ...
    fn render(
        ...
        let dropdown = render_dropdown_item(
            appearance,
            "自定义应用图标",
            show_bundle_warning.then_some("更改应用图标需要使用打包后的应用。"),
            None,
        ...
        #[cfg(target_os = "macos")]
        {
                ...
                && app_icon_at_startup != AppIcon::Default
            {
                ...
                let column = Flex::column().with_child(dropdown).with_child(
                    appearance
                        .ui_builder()
                        .wrappable_text("在 macOS 上可能需要重启 tzWarp 才能应用图标样式。", true)
    ...
    fn render(
        ...
        if let Some(window) = app.windows().platform_window(view.window_id) {
            ...
            if !window.supports_transparency() && window.graphics_backend() != GraphicsBackend::Gl {
                let mut message = Cow::Borrowed("当前图形设置可能不支持透明窗口。");
    ...
    fn render(
        ...
        render_body_item::<AppearancePageAction>(
            ...
            appearance
                ...
                .finish(),
            Some("在工具面板中显示项目资源管理器/文件树。".to_string()),
        )
    }
}
    ...
    fn render(
        ...
        render_body_item::<AppearancePageAction>(
            ...
            appearance
                ...
                .finish(),
            Some("在工具面板中显示智能体对话历史。".to_string()),
        )
    }
}
    ...
    fn render(
        ...
        render_body_item::<AppearancePageAction>(
            ...
            appearance
                ...
                .finish(),
            Some("在工具面板中显示 Warp Drive。".to_string()),
        )
    }
}
    ...
    fn render_line_height_editor(
        ...
        line_height.add_child({
            let button = appearance
                ...
                .with_text_label("重置为默认".to_string());
    ...
    fn render(
        ...
        render_body_item::<AppearancePageAction>(
            ...
            appearance
                ...
                .finish(),
            Some(
                "开启后，重新打开或恢复窗口时会显示垂直标签面板，即使上次关闭窗口时该面板是收起的。"
                    .to_string(),
            ),
        )
    }
    ...
    fn render(
        ...
        render_body_item::<AppearancePageAction>(
            ...
            appearance
                ...
                .finish(),
            Some(
                "使用垂直标签布局时，隐藏标题栏中的搜索框。仍可通过命令面板和快捷键搜索。"
                    .to_string(),
            ),
        )
    }
