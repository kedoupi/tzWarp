...
const TAB_KEYSTROKE_STR: &str = "标签页";
...
fn block_maximum_rows_description() -> String {
    ...
    format!("超过 10 万行可能影响性能。最大支持 {max_rows} 行。")
}
...
impl FeaturesPageView {
    ...
    fn new_tab_placement_dropdown_item_label(val: NewTabPlacement) -> &'static str {
        match val {
            NewTabPlacement::AfterAllTabs => "所有标签之后",
            NewTabPlacement::AfterCurrentTab => "当前标签之后",
        }
    }
        ...
        dropdown.update(
            ...
            |dropdown: &mut FilterableDropdown<FeaturesPageAction>, ctx| {
                ...
                let mut items: Vec<DropdownItem<FeaturesPageAction>> = DefaultSessionMode::iter()
                    ...
                    .filter(|val| {
                        // tzWarp 没有 Warp 云端 Agent。
                        !(cfg!(feature = "team_relay") && *val == DefaultSessionMode::CloudAgent)
                    })
                    .map(|val| {
                        DropdownItem::new(
                            val.display_name(),
    ...
    fn render_long_running_notifications_setting(
        ...
        Flex::row()
            ...
            .with_child(
                Container::new(
                    Align::new(
                        Text::new_inline("当命令运行超过", appearance.ui_font_family(), font_size)
            ...
            .with_child(
                Container::new(
                    Align::new(
                        Text::new_inline("秒时", appearance.ui_font_family(), font_size)
                            .with_color(font_color.into())
                            .finish(),
                    )
                    .finish(),
            ...
            Flex::row()
                ...
                .with_child(
                    Shrinkable::new(
                        2.,
                        Align::new(
                            Text::new_inline("快捷键", appearance.ui_font_family(), 13.)
    ...
    fn render_change_keybinding_button(
        ...
        Hoverable::new(
            ...
            |state| {
                ...
                Container::new(
                    Text::new_inline("更改快捷键", appearance.ui_font_family(), 12.)
...
fn init_display_count_dropdown(
    ...
    match quake_mode_settings.pin_screen {
        ...
        _ => dropdown.set_selected_by_name("当前屏幕", ctx),
    };
}
...
impl SettingsWidget for LoginItemWidget {
    ...
    fn render(
        ...
        let ui_builder = appearance.ui_builder();
        #[cfg(target_os = "macos")]
        let label = "登录时启动 tzWarp（需 macOS 13+）";
        #[cfg(not(target_os = "macos"))]
        let label = "登录时启动 tzWarp";
        render_body_item::<FeaturesPageAction>(
            label.into(),
            None,
            LocalOnlyIconState::for_setting(
    ...
    fn render(
        ...
        render_body_item::<FeaturesPageAction>(
            ...
            Some(AdditionalInfo {
                ...
                on_click_action: None,
                secondary_text: None,
                tooltip_override_text: Some("支持 1 到 20 之间的浮点数。".to_string()),
            }),
            LocalOnlyIconState::for_setting(
    ...
    fn render(
        ...
        render_body_item::<FeaturesPageAction>(
            ...
            ui_builder
                ...
                .finish(),
            Some("开启后，对话中首次接受差异时将自动打开代码审查面板".into()),
        )
    }
}
...
impl SettingsWidget for DefaultTerminalWidget {
    ...
    fn render(
        ...
        if default_terminal.is_warp_default() {
            ui_builder
                .wrappable_text("tzWarp 已是默认终端", true)
                .with_style(UiComponentStyles {
        ...
        if FeatureFlag::HOANotifications.is_enabled() {
            ...
            if show_agent_notifications {
                ...
                let toast_duration_row = Flex::row()
                    .with_cross_axis_alignment(CrossAxisAlignment::Center)
                    .with_child(
                        Text::new_inline("通知显示时长", appearance.ui_font_family(), font_size)
                            .with_color(font_color.into())
                            .finish(),
                    )
                    .with_child(
    ...
    fn render(
        ...
        if app.is_wayland() {
            column.add_child(render_body_item::<FeaturesPageAction>(
                ...
                Flex::row()
                    .with_children([
                        ui_builder.span("Wayland 上不支持。").build().finish(),
                        ui_builder
                            .link(
                                "查看文档".to_owned(),
                                Some(
    ...
    fn render_tab_behavior_setting_secondary_row(
        ...
        let other_keybinding_info = match *view.tab_behavior {
            TabBehavior::Completions if view.autosuggestions_keystroke.is_empty() => {
                // If the "接受自动建议" keybinding is unbound, the
...
impl SettingsWidget for AsyncFindWidget {
    ...
    fn render(
        ...
        build_toggle_element(
            ...
            switch,
            appearance,
            Some("使用改进的查找实现，在大输出上搜索时保持界面流畅。".into()),
        )
    }
}
