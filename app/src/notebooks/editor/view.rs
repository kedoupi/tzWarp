...
pub fn init(app: &mut AppContext) {
    ...
    app.register_editable_bindings([
        ...
        EditableBinding::new("editor_view:up", "光标上移", EditorViewAction::MoveUp)
            .with_context_predicate(text_entry.clone())
            .with_key_binding("ctrl-p"),
        EditableBinding::new("editor_view:down", "光标下移", EditorViewAction::MoveDown)
            .with_context_predicate(text_entry.clone())
            .with_key_binding("ctrl-n"),
        EditableBinding::new("editor_view:left", "光标左移", EditorViewAction::MoveLeft)
            .with_context_predicate(text_entry.clone())
            .with_key_binding("ctrl-b"),
        EditableBinding::new("editor_view:right", "光标右移", EditorViewAction::MoveRight)
            .with_context_predicate(text_entry.clone())
