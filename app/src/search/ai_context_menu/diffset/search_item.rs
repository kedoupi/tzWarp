...
impl DiffSetSearchItem {
    pub fn name(&self) -> String {
        match &self.diff_mode {
            ...
            DiffMode::MainBranch => "相对主分支的更改".to_string(),
    ...
    pub fn description(&self) -> String {
        match &self.diff_mode {
            DiffMode::Head => "工作区中所有未提交的更改".to_string(),
            DiffMode::MainBranch => "相对主分支的全部更改".to_string(),
            DiffMode::OtherBranch(branch) => format!("相对 {branch} 的全部更改"),
        }
    }
}
