...
const FILTER_BLOCK_PLACEHOLDER_TEXT: &str = "筛选块输出";
...
const CONTEXT_LINE_EDITOR_TOOLTIP_LABEL: &str = "显示匹配行上下文";
const REGEX_TOOLTIP_LABEL: &str = "切换 Regex";
const CASE_SENSITIVITY_TOOLTIP_LABEL: &str = "区分大小写";
const INVERT_FILTER_TOOLTIP_LABEL: &str = "反向筛选";
