...
impl ChannelState {
    ...
    pub fn enable_debug_features() -> bool {
        // Explicit override: WARP_DEBUG_FEATURES=1/0.
        // tzWarp (tzworp) defaults this to "0" so debug palette commands stay hidden
        // in product builds; set WARP_DEBUG_FEATURES=1 to re-enable.
        match std::env::var("WARP_DEBUG_FEATURES") {
