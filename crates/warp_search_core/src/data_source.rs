...
impl QueryFilter {
    ...
    pub fn display_name(&self) -> &'static str {
        match self {
            ...
            QueryFilter::FullTerminalUseModels => "完整终端模型",
